...
LIBDIVIDE_API struct libdivide_s32_branchfree_t libdivide_s32_branchfree_gen(
    int32_t y);
LIBDIVIDE_API struct libdivide_u32_branchfree_t libdivide_u32_branchfree_gen(
    uint32_t y);
LIBDIVIDE_API struct libdivide_s64_branchfree_t libdivide_s64_branchfree_gen(
    int64_t y);
LIBDIVIDE_API struct libdivide_u64_branchfree_t libdivide_u64_branchfree_gen(
    uint64_t y);
...
LIBDIVIDE_API int32_t libdivide_s32_branchfree_do(
    int32_t numer, const struct libdivide_s32_branchfree_t* denom);
LIBDIVIDE_API uint32_t libdivide_u32_branchfree_do(
    uint32_t numer, const struct libdivide_u32_branchfree_t* denom);
LIBDIVIDE_API int64_t libdivide_s64_branchfree_do(
    int64_t numer, const struct libdivide_s64_branchfree_t* denom);
LIBDIVIDE_API uint64_t libdivide_u64_branchfree_do(
    uint64_t y, const struct libdivide_u64_branchfree_t* denom);
...
LIBDIVIDE_API int32_t libdivide_s32_branchfree_recover(
    const struct libdivide_s32_branchfree_t* denom);
LIBDIVIDE_API uint32_t libdivide_u32_branchfree_recover(
    const struct libdivide_u32_branchfree_t* denom);
LIBDIVIDE_API int64_t libdivide_s64_branchfree_recover(
    const struct libdivide_s64_branchfree_t* denom);
LIBDIVIDE_API uint64_t libdivide_u64_branchfree_recover(
...
LIBDIVIDE_API __m128i libdivide_u32_branchfree_do_vector(
    __m128i numers, const struct libdivide_u32_branchfree_t* denom);
LIBDIVIDE_API __m128i libdivide_s32_branchfree_do_vector(
    __m128i numers, const struct libdivide_s32_branchfree_t* denom);
LIBDIVIDE_API __m128i libdivide_u64_branchfree_do_vector(
    __m128i numers, const struct libdivide_u64_branchfree_t* denom);
LIBDIVIDE_API __m128i libdivide_s64_branchfree_do_vector(
...
static inline __m128i libdivide__mullhi_u32_flat_vector(__m128i a, __m128i b) {
  ...
  __m128i hi_product_Z1Z3 =
      _mm_and_si128(_mm_mul_epu32(a1X3X, b), libdivide_get_FFFFFFFF00000000());
...
static inline __m128i libdivide_mullhi_s32_flat_vector(__m128i a, __m128i b) {
  ...
  __m128i a1X3X = _mm_srli_epi64(a, 32);
  __m128i hi_product_Z1Z3 =
      _mm_and_si128(_mm_mul_epi32(a1X3X, b), libdivide_get_FFFFFFFF00000000());
  return _mm_or_si128(hi_product_0Z2Z, hi_product_Z1Z3);  // = hi_product_0123
}
...
static inline void libdivide_u128_shift(uint64_t* u1, uint64_t* u0,
...
static uint64_t libdivide_128_div_128_to_64(uint64_t u_hi, uint64_t u_lo,
...
static inline struct libdivide_u32_t libdivide_internal_u32_gen(
...
uint32_t libdivide_u32_recover(const struct libdivide_u32_t* denom) {
  ...
  if (more & LIBDIVIDE_U32_SHIFT_PATH) {
    ...
    // We rounded down in gen unless we're a power of 2 (i.e. in branchfree
    // case) We can detect that by looking at m. If m zero, we're a power of 2
...
uint32_t libdivide_u32_branchfree_recover(
    const struct libdivide_u32_branchfree_t* denom) {
  struct libdivide_u32_t denom_u32 = {
      denom->magic, (uint8_t)(denom->more | LIBDIVIDE_ADD_MARKER)};
...
static inline struct libdivide_u64_t libdivide_internal_u64_gen(
  ...
  if ((d & (d - 1)) == 0) {
    ...
    uint8_t more;
    proposed_m =
        libdivide_128_div_64_to_64(1ULL << floor_log_2_d, 0, d,
...
uint64_t libdivide_u64_recover(const struct libdivide_u64_t* denom) {
  ...
  if (more & LIBDIVIDE_U64_SHIFT_PATH) {
    ...
    uint64_t r_hi, r_lo;
    uint64_t half_q = libdivide_128_div_128_to_64(half_n_hi, half_n_lo, d_hi,
                                                  d_lo, &r_hi, &r_lo);
...
uint64_t libdivide_u64_branchfree_recover(
    const struct libdivide_u64_branchfree_t* denom) {
  struct libdivide_u64_t denom_u64 = {
      denom->magic, (uint8_t)(denom->more | LIBDIVIDE_ADD_MARKER)};
...
static inline struct libdivide_s32_t libdivide_internal_s32_gen(
  ...
  uint32_t absD =
      (d < 0 ? -ud : ud);  // gcc optimizes this to the fast abs trick
...
__m128i libdivide_s32_do_vector(__m128i numers,
  ...
  if (more & LIBDIVIDE_S32_SHIFT_PATH) {
    ...
    __m128i shiftMask = _mm_set1_epi32(
        (int32_t)((int8_t)more >>
                  7));  // set all bits of shift mask = to the sign bit of more
    ...
    if (more & LIBDIVIDE_ADD_MARKER) {
      ...
      q = _mm_add_epi32(q,
                        _mm_sub_epi32(_mm_xor_si128(numers, sign),
                                      sign));  // q += ((numer ^ sign) - sign);
    }
    q = _mm_sra_epi32(q, libdivide_u32_to_m128i(
                             more & LIBDIVIDE_32_SHIFT_MASK));  // q >>= shift
...
__m128i libdivide_s32_branchfree_do_vector(
    __m128i numers, const struct libdivide_s32_branchfree_t* denom) {
  int32_t magic = denom->magic;
  uint8_t more = denom->more;
  uint8_t shift = more & LIBDIVIDE_32_SHIFT_MASK;
  __m128i sign =
      _mm_set1_epi32((int32_t)(int8_t)more >> 7);  // must be arithmetic shift
  ...
  q = _mm_add_epi32(
      q,
      _mm_and_si128(
          q_sign, _mm_set1_epi32((1 << shift) -
                                 is_power_of_2)));  // q = q + (q_sign & ((1 <<
                                                    // shift) - is_power_of_2)
...
static inline struct libdivide_s64_t libdivide_internal_s64_gen(
  ...
  if ((absD & (absD - 1)) == 0) {
    ...
    proposed_m =
        libdivide_128_div_64_to_64(1ULL << (floor_log_2_d - 1), 0, absD, &rem);
...
__m128i libdivide_s64_do_vector(__m128i numers,
  ...
  if (magic == 0) {  // shift path
    ...
    __m128i q = _mm_add_epi64(
        numers, _mm_and_si128(libdivide_s64_signbits(numers),
    ...
    __m128i q =
        libdivide_mullhi_s64_flat_vector(numers, libdivide__u64_to_m128(magic));
    if (more & LIBDIVIDE_ADD_MARKER) {
      __m128i sign = _mm_set1_epi32(
          (int32_t)((int8_t)more >> 7));  // must be arithmetic shift
      q = _mm_add_epi64(q,
                        _mm_sub_epi64(_mm_xor_si128(numers, sign),
                                      sign));  // q += ((numer ^ sign) - sign);
    }
...
__m128i libdivide_s64_do_vector_alg0(__m128i numers,
  ...
  __m128i roundToZeroTweak = libdivide__u64_to_m128((1ULL << shifter) - 1);
  __m128i q = _mm_add_epi64(
      numers, _mm_and_si128(libdivide_s64_signbits(numers), roundToZeroTweak));
...
__m128i libdivide_s64_branchfree_do_vector(
    __m128i numers, const struct libdivide_s64_branchfree_t* denom) {
  int64_t magic = denom->magic;
  uint8_t more = denom->more;
  uint8_t shift = more & LIBDIVIDE_64_SHIFT_MASK;
  ...
  q = _mm_add_epi64(
      q,
      _mm_and_si128(q_sign, libdivide__u64_to_m128(
                                (1ULL << shift) -
                                is_power_of_2)));   // q = q + (q_sign & ((1 <<
                                                    // shift) - is_power_of_2)
...
struct denom_u32 {
  typedef base<uint32_t, libdivide_u32_t, gen_func, do_func, vector_func>
      divider;
};
template <int ALGO>
struct algo_u32 {};
template <>
struct algo_u32<BRANCHFULL> {
  typedef denom_u32<libdivide_u32_do,
                    MAYBE_VECTOR(libdivide_u32_do_vector)>::divider divider;
};
template <>
struct algo_u32<ALGORITHM0> {
  typedef denom_u32<libdivide_u32_do_alg0,
                    MAYBE_VECTOR(libdivide_u32_do_vector_alg0)>::divider
      divider;
};
template <>
struct algo_u32<ALGORITHM1> {
  typedef denom_u32<libdivide_u32_do_alg1,
                    MAYBE_VECTOR(libdivide_u32_do_vector_alg1)>::divider
      divider;
};
template <>
struct algo_u32<ALGORITHM2> {
  typedef denom_u32<libdivide_u32_do_alg2,
                    MAYBE_VECTOR(libdivide_u32_do_vector_alg2)>::divider
      divider;
};
template <>
struct algo_u32<BRANCHFREE> {
  typedef base<uint32_t, libdivide_u32_branchfree_t,
               libdivide_u32_branchfree_gen, libdivide_u32_branchfree_do,
               MAYBE_VECTOR(libdivide_u32_branchfree_do_vector)>
      divider;
};
...
struct denom_u64 {
  typedef base<uint64_t, libdivide_u64_t, gen_func, do_func, vector_func>
      divider;
};
template <int ALGO>
struct algo_u64 {};
template <>
struct algo_u64<BRANCHFULL> {
  typedef denom_u64<libdivide_u64_do,
                    MAYBE_VECTOR(libdivide_u64_do_vector)>::divider divider;
};
template <>
struct algo_u64<ALGORITHM0> {
  typedef denom_u64<libdivide_u64_do_alg0,
                    MAYBE_VECTOR(libdivide_u64_do_vector_alg0)>::divider
      divider;
};
template <>
struct algo_u64<ALGORITHM1> {
  typedef denom_u64<libdivide_u64_do_alg1,
                    MAYBE_VECTOR(libdivide_u64_do_vector_alg1)>::divider
      divider;
};
template <>
struct algo_u64<ALGORITHM2> {
  typedef denom_u64<libdivide_u64_do_alg2,
                    MAYBE_VECTOR(libdivide_u64_do_vector_alg2)>::divider
      divider;
};
template <>
struct algo_u64<BRANCHFREE> {
  typedef base<uint64_t, libdivide_u64_branchfree_t,
               libdivide_u64_branchfree_gen, libdivide_u64_branchfree_do,
               MAYBE_VECTOR(libdivide_u64_branchfree_do_vector)>
      divider;
};
...
struct denom_s32 {
  typedef base<int32_t, libdivide_s32_t, libdivide_s32_gen, do_func,
               vector_func>
      divider;
};
template <int ALGO>
struct algo_s32 {};
template <>
struct algo_s32<BRANCHFULL> {
  typedef denom_s32<libdivide_s32_do,
                    MAYBE_VECTOR(libdivide_s32_do_vector)>::divider divider;
};
template <>
struct algo_s32<ALGORITHM0> {
  typedef denom_s32<libdivide_s32_do_alg0,
                    MAYBE_VECTOR(libdivide_s32_do_vector_alg0)>::divider
      divider;
};
template <>
struct algo_s32<ALGORITHM1> {
  typedef denom_s32<libdivide_s32_do_alg1,
                    MAYBE_VECTOR(libdivide_s32_do_vector_alg1)>::divider
      divider;
};
template <>
struct algo_s32<ALGORITHM2> {
  typedef denom_s32<libdivide_s32_do_alg2,
                    MAYBE_VECTOR(libdivide_s32_do_vector_alg2)>::divider
      divider;
};
template <>
struct algo_s32<ALGORITHM3> {
  typedef denom_s32<libdivide_s32_do_alg3,
                    MAYBE_VECTOR(libdivide_s32_do_vector_alg3)>::divider
      divider;
};
template <>
struct algo_s32<ALGORITHM4> {
  typedef denom_s32<libdivide_s32_do_alg4,
                    MAYBE_VECTOR(libdivide_s32_do_vector_alg4)>::divider
      divider;
};
template <>
struct algo_s32<BRANCHFREE> {
  typedef base<int32_t, libdivide_s32_branchfree_t,
               libdivide_s32_branchfree_gen, libdivide_s32_branchfree_do,
               MAYBE_VECTOR(libdivide_s32_branchfree_do_vector)>
      divider;
};
...
struct denom_s64 {
  typedef base<int64_t, libdivide_s64_t, libdivide_s64_gen, do_func,
               vector_func>
      divider;
};
template <int ALGO>
struct algo_s64 {};
template <>
struct algo_s64<BRANCHFULL> {
  typedef denom_s64<libdivide_s64_do,
                    MAYBE_VECTOR(libdivide_s64_do_vector)>::divider divider;
};
template <>
struct algo_s64<ALGORITHM0> {
  typedef denom_s64<libdivide_s64_do_alg0,
                    MAYBE_VECTOR(libdivide_s64_do_vector_alg0)>::divider
      divider;
};
template <>
struct algo_s64<ALGORITHM1> {
  typedef denom_s64<libdivide_s64_do_alg1,
                    MAYBE_VECTOR(libdivide_s64_do_vector_alg1)>::divider
      divider;
};
template <>
struct algo_s64<ALGORITHM2> {
  typedef denom_s64<libdivide_s64_do_alg2,
                    MAYBE_VECTOR(libdivide_s64_do_vector_alg2)>::divider
      divider;
};
template <>
struct algo_s64<ALGORITHM3> {
  typedef denom_s64<libdivide_s64_do_alg3,
                    MAYBE_VECTOR(libdivide_s64_do_vector_alg3)>::divider
      divider;
};
template <>
struct algo_s64<ALGORITHM4> {
  typedef denom_s64<libdivide_s64_do_alg4,
                    MAYBE_VECTOR(libdivide_s64_do_vector_alg4)>::divider
      divider;
};
template <>
struct algo_s64<BRANCHFREE> {
  typedef base<int64_t, libdivide_s64_branchfree_t,
               libdivide_s64_branchfree_gen, libdivide_s64_branchfree_do,
               MAYBE_VECTOR(libdivide_s64_branchfree_do_vector)>
      divider;
};

// Bogus versions to allow templated code to operate on int and uint uniformly
template <>
struct algo_u32<ALGORITHM3> {
  typedef denom_u32<crash_u32, MAYBE_VECTOR(crash_u32_vector)>::divider divider;
};
template <>
struct algo_u32<ALGORITHM4> {
  typedef denom_u32<crash_u32, MAYBE_VECTOR(crash_u32_vector)>::divider divider;
};
template <>
struct algo_u64<ALGORITHM3> {
  typedef denom_u64<crash_u64, MAYBE_VECTOR(crash_u64_vector)>::divider divider;
};
template <>
struct algo_u64<ALGORITHM4> {
  typedef denom_u64<crash_u64, MAYBE_VECTOR(crash_u64_vector)>::divider divider;
};
...
struct dispatcher {};
template <int ALGO>
struct dispatcher<uint32_t, ALGO> {
  typedef struct algo_u32<ALGO> algo;
};
template <int ALGO>
struct dispatcher<int32_t, ALGO> {
  typedef struct algo_s32<ALGO> algo;
};
template <int ALGO>
struct dispatcher<uint64_t, ALGO> {
  typedef struct algo_u64<ALGO> algo;
};
template <int ALGO>
struct dispatcher<int64_t, ALGO> {
  typedef struct algo_s64<ALGO> algo;
};

// Overloads that don't depend on the algorithm.
inline uint32_t recover(const libdivide_u32_t* s) {
  return libdivide_u32_recover(s);
}
inline int32_t recover(const libdivide_s32_t* s) {
  return libdivide_s32_recover(s);
}
inline uint64_t recover(const libdivide_u64_t* s) {
  return libdivide_u64_recover(s);
}
inline int64_t recover(const libdivide_s64_t* s) {
  return libdivide_s64_recover(s);
}

inline uint32_t recover(const libdivide_u32_branchfree_t* s) {
  return libdivide_u32_branchfree_recover(s);
}
inline int32_t recover(const libdivide_s32_branchfree_t* s) {
  return libdivide_s32_branchfree_recover(s);
}
inline uint64_t recover(const libdivide_u64_branchfree_t* s) {
  return libdivide_u64_branchfree_recover(s);
}
inline int64_t recover(const libdivide_s64_branchfree_t* s) {
  return libdivide_s64_branchfree_recover(s);
}

inline int get_algorithm(const libdivide_u32_t* s) {
  return libdivide_u32_get_algorithm(s);
}
inline int get_algorithm(const libdivide_s32_t* s) {
  return libdivide_s32_get_algorithm(s);
}
inline int get_algorithm(const libdivide_u64_t* s) {
  return libdivide_u64_get_algorithm(s);
}
inline int get_algorithm(const libdivide_s64_t* s) {
  return libdivide_s64_get_algorithm(s);
}
...
class divider {
 ...
 public:
  ...
  int get_algorithm() const {
    return libdivide_internal::get_algorithm(&sub.denom);
  }
...
divider<T, NEW_ALGO> unswitch(const divider<T, BRANCHFULL>& d) {
  return divider<T, NEW_ALGO>(d.sub.denom);
}
