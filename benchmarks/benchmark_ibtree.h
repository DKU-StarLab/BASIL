...
#include "wrappers/wrapper_ibtree.h"
...
*/
  ...
  benchmark.template Run<InterpolationBTree<uint64_t, 1>>();
  benchmark.template Run<InterpolationBTree<uint64_t, 4>>();
  benchmark.template Run<InterpolationBTree<uint64_t, 16>>();
  ...
  benchmark.template Run<InterpolationBTree<uint64_t, 16384>>();
  benchmark.template Run<InterpolationBTree<uint64_t, 65536>>();
  benchmark.template Run<InterpolationBTree<uint64_t, 262144>>();
  benchmark.template Run<InterpolationBTree<uint64_t, 1048576>>();
#endif
