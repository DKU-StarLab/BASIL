...
void Compare() {
  ...
  for (unsigned i = 1; i <= 10; ++i) {
    for (unsigned j = 1; j <= 10; ++j) {
      ...
      scht::Builder<KeyType> spchtb(min, max, numBins, maxError/2, 2, true, false);
      scht::Builder<KeyType> ochtb(min, max, numBins, maxError/2, 2, false, false);
...
void Benchmark(bool single_pass) {
  ...
  for (unsigned i = 1; i <= 10; ++i) {
    for (unsigned j = 1; j <= 10; ++j) {
      ...
      scht::Builder<KeyType> chtb(min, max, numBins, maxError/2, 2, single_pass,
                                 false);
      scht::Builder<KeyType> cchtb(min, max, numBins, maxError/2, 2, single_pass,
                                  true);
