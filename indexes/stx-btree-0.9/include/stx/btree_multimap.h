...
class btree_multimap {
 ...
 public:
  ...
  void swap(self& from) { std::swap(tree, from.tree); }
 ...
 public:
  ...
  inline bool operator<(const self& other) const { return (tree < other.tree); }
 ...
 public:
  ...
  inline btree_multimap(const self& other) : tree(other.tree) {}
 ...
 public:
  ...
  template <typename Iterator>
  inline void sampled_bulk_load(Iterator first, Iterator last,
                                int sampling_interval) {
    return tree.sampled_bulk_load(first, last, sampling_interval);
  }
