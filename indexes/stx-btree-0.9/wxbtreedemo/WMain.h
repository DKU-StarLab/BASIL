...
#define BTREE_FRIENDS                                              \
  ...
  template <class BTreeType>                                       \
  friend wxSize WTreeDrawing::BTreeOp_Draw::draw_node(             \
      int, int, const class BTreeType::btree_impl::node*);
...
class BTreeBundle {
 public:
  ...
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<4, int> >
      btmap_int_4_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<5, int> >
      btmap_int_5_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<6, int> >
      btmap_int_6_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<7, int> >
      btmap_int_7_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<8, int> >
      btmap_int_8_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<9, int> >
      btmap_int_9_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<10, int> >
      btmap_int_10_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<11, int> >
      btmap_int_11_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<12, int> >
      btmap_int_12_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<13, int> >
      btmap_int_13_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<14, int> >
      btmap_int_14_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<15, int> >
      btmap_int_15_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<16, int> >
      btmap_int_16_slots;
  stx::btree_map<int, int, std::less<int>, btree_traits_nodebug<32, int> >
      btmap_int_32_slots;

  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<4, wxString> >
      btmap_string_4_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<5, wxString> >
      btmap_string_5_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<6, wxString> >
      btmap_string_6_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<7, wxString> >
      btmap_string_7_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<8, wxString> >
      btmap_string_8_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<9, wxString> >
      btmap_string_9_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<10, wxString> >
      btmap_string_10_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<11, wxString> >
      btmap_string_11_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<12, wxString> >
      btmap_string_12_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<13, wxString> >
      btmap_string_13_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<14, wxString> >
      btmap_string_14_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<15, wxString> >
      btmap_string_15_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<16, wxString> >
      btmap_string_16_slots;
  stx::btree_map<wxString, wxString, std::less<wxString>,
                 btree_traits_nodebug<32, wxString> >
      btmap_string_32_slots;

  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<4, int> >
      btmultimap_int_4_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<5, int> >
      btmultimap_int_5_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<6, int> >
      btmultimap_int_6_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<7, int> >
      btmultimap_int_7_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<8, int> >
      btmultimap_int_8_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<9, int> >
      btmultimap_int_9_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<10, int> >
      btmultimap_int_10_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<11, int> >
      btmultimap_int_11_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<12, int> >
      btmultimap_int_12_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<13, int> >
      btmultimap_int_13_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<14, int> >
      btmultimap_int_14_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<15, int> >
      btmultimap_int_15_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<16, int> >
      btmultimap_int_16_slots;
  stx::btree_multimap<int, int, std::less<int>, btree_traits_nodebug<32, int> >
      btmultimap_int_32_slots;

  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<4, wxString> >
      btmultimap_string_4_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<5, wxString> >
      btmultimap_string_5_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<6, wxString> >
      btmultimap_string_6_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<7, wxString> >
      btmultimap_string_7_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<8, wxString> >
      btmultimap_string_8_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<9, wxString> >
      btmultimap_string_9_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<10, wxString> >
      btmultimap_string_10_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<11, wxString> >
      btmultimap_string_11_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<12, wxString> >
      btmultimap_string_12_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<13, wxString> >
      btmultimap_string_13_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<14, wxString> >
      btmultimap_string_14_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<15, wxString> >
      btmultimap_string_15_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<16, wxString> >
      btmultimap_string_16_slots;
  stx::btree_multimap<wxString, wxString, std::less<wxString>,
                      btree_traits_nodebug<32, wxString> >
      btmultimap_string_32_slots;
  ...
  inline bool isIntegerType() const { return (selected_type == 0); }

  /// Test if this is a string tree
  inline bool isStringType() const { return (selected_type == 1); }

  /// Test if the selected tree allows duplicates
  inline bool isMultimap() const { return selected_multimap; }
